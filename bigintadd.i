...
# 41 "bigintadd.c"
  "oAddend1 != NULL"
# 41 "bigintadd.c" 3 4
  , "bigintadd.c", 41, __extension__ __PRETTY_FUNCTION__))
# 41 "bigintadd.c"
                          ;
...
# 42 "bigintadd.c"
  "oAddend2 != NULL"
# 42 "bigintadd.c" 3 4
  , "bigintadd.c", 42, __extension__ __PRETTY_FUNCTION__))
# 42 "bigintadd.c"
                          ;
...
# 43 "bigintadd.c"
  "oSum != NULL"
# 43 "bigintadd.c" 3 4
  , "bigintadd.c", 43, __extension__ __PRETTY_FUNCTION__))
# 43 "bigintadd.c"
                      ;
...
# 44 "bigintadd.c"
  "oSum != oAddend1"
# 44 "bigintadd.c" 3 4
  , "bigintadd.c", 44, __extension__ __PRETTY_FUNCTION__))
# 44 "bigintadd.c"
                          ;
...
# 45 "bigintadd.c"
  "oSum != oAddend2"
# 45 "bigintadd.c" 3 4
  , "bigintadd.c", 45, __extension__ __PRETTY_FUNCTION__))
# 45 "bigintadd.c"
                          ;
